  ...
  create view "postgres"."mint"."ad_ledger__dbt_tmp" as (
    with
dte as (select distinct first_day_of_month from "postgres"."mint"."d_date" where year_actual between 2015 and 2021),
f as (select * from "postgres"."mint"."ad_fixed_total_model"),
d as (select * from "postgres"."mint"."ad_discretionary_total_model"),
i as (select * from "postgres"."mint"."ad_income_total_model"),
fa as (select * from "postgres"."mint"."ad_fa_total_model")
