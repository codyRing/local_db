...
Transactions_D = pd.read_sql('select * from mint.inter_budget_fixed_model'
                             , con=main.conn
...
plt.savefig('./Images/Monthly_Fixed_Z_{}.png'.format(datetime.now().strftime("%Y%m%d")), dpi=300)
...
ax.set_xlabel('Month')
ax.set_ylabel('Day')
plt.savefig('./Images/Daily_Fixed_Heat_{}.png'.format(datetime.now().strftime("%Y%m%d")), dpi=300)
...
ax.set_xlabel('Month')
ax.set_ylabel('Day')
plt.savefig('./Images/Daily_Fixed_Heat_Z_{}.png'.format(datetime.now().strftime("%Y%m%d")), dpi=300)
