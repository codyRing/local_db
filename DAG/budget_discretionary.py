...
plt.savefig('./Images/Monthly_Discretionary_Z_{}.png'.format(datetime.now().strftime("%Y%m%d")), dpi=300)
...
ax.set_xlabel('Month')
ax.set_ylabel('Day')
plt.savefig('./Images/Daily_Discretionary_Heat_{}.png'.format(datetime.now().strftime("%Y%m%d")), dpi=300)
...
ax.set_xlabel('Month')
ax.set_ylabel('Day')
plt.savefig('./Images/Daily_Discretionary_Heat_Z_{}.png'.format(datetime.now().strftime("%Y%m%d")), dpi=300)
